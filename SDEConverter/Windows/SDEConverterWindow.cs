...
namespace SDEConverter
{
    public partial class SDEConverterWindow : Form
    {
        ...
        {
            MemoryStream stream = new MemoryStream(Properties.Resources.iconIDs);
        ...
        {
            MemoryStream stream = new MemoryStream(Properties.Resources.certificates);
            StreamReader reader = new StreamReader(stream);
            YamlStream yaml = new YamlStream();
        ...
        private void addSqlAttributeGroupColumn(SQLiteConnection connection)
        {
            ...
            String attributeFile = Properties.Resources.attributeGroups.Replace("\r\n", ((char)13).ToString());
